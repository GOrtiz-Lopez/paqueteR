# Getting help with `paqueteR`

Thank you for using `paqueteR`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/paqueteR`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/paqueteR),
...
[search issues and pull requests](https://github.com/GOrtiz-Lopez/paqueteR/issues)
